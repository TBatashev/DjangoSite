...
class PostManager(models.Manager):
    ...
    def get_queryset(self) :
        ...
        # К методу кастомного менеджера модели добавим до фильтрации по статусу метод: select_related() для ключа Foreign Key - 
        # Автора и Категорий, так как со статьи мы ссылаемся на автора и категорию.
...
class Post(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('post_detail', kwargs={'slug' : self.slug}) # Получаем прямую ссылку на статью
