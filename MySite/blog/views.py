...
class PostListView(ListView):
    ...
    context_object_name = 'posts' # имя Queryset
    paginate_by = 2
    ...
    def get_context_data(self, **kwargs: Any) -> dict[str, Any]:
        ...
        что очень полезно. Например, в нашем случае мы передаем значение заголовка страницы.
        """
...
class PostDetailView(DetailView):
    ...
    context_object_name = 'post' # имя Queryset

    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['title'] = self.object.title # наш заголовок передаваемый в шаблон, а self.object.title - это наш объект, т.е наша статья, у которой мы получаем заголовок.
        context['form'] = CommentCreateForm # Мы добавили в вывод нашей формы в шаблон, используя переменную {{ form }}.
        return context
...
class PostUpdateView(AuthorRequiredMixin,SuccessMessageMixin,UpdateView):
    ...
    login_url = 'home'
    success_message = 'Запись успешно обработана'
