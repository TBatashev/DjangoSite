...
class Profile(models.Model):
    ...
    # мы используем валидатор для изображений, который разрешает только загрузку указанных расширений изображения.
    ...
    def save(self, *args, **kwargs): # Ещё мы добавили метод сохранения для генерации slug
        """
